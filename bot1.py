...
async def reboot(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        # Stop brute-force and clear user data
...
async def help_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await query.message.reply_text(
        ...
        "3. Check Link: Test URLs/IPs for admin panels\n"
        "4. Status: Bot health\n"
...
async def check_link(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if input_text.startswith(("http://", "https://")):
        ...
        # Extract IP from netloc if hostname is None
